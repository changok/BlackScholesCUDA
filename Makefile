...
all: parser.o main.o timer.o black.o bsconfig.o
	nvcc $(ARCH_OPT) $(BIN_DIR)/main.o $(BIN_DIR)/timer.o $(BIN_DIR)/black_scholes.o $(BIN_DIR)/parser.o $(BIN_DIR)/bsconfig.o -o $(BIN_DIR)/blackScholes 
...
parser.o: $(MAKE_BIN_DIR_TARGET)
	nvcc $(ARCH_OPT) -I${INCLUDE_DIR} -c $(SRC_DIR)/parser.cpp -o  $(BIN_DIR)/parser.o
	
bsconfig.o: $(MAKE_BIN_DIR_TARGET)
	g++ -I${INCLUDE_DIR} -c $(SRC_DIR)/bsconfig.cpp -o  $(BIN_DIR)/bsconfig.o
